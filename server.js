...
if (!port) {
  console.log("请指定端口号可以吗？求你了！\nnode server.js 8888 就像左边这样的格式可以吗？");
  process.exit(1);
}
...
var server = http.createServer(function (request, response) {
  ...
  console.log("猪头，你有一个请求过来啦！路径（带查询参数）为：" + pathWithQuery);
  ...
  if (path === "/index.html") {
    ...
    string =  string.replace('{{page1}}', `<ul id="nextpage">${result}</ul>`)
...
console.log(
  "监听 " +
  port +
  " 成功\n你需要在空中转体720度，然后用电视打开 http://localhost:" +
  port
);